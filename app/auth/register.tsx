...
export default function RegisterScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-6 pt-8">
      ...
      <Text className="text-gray-500 mb-8">Join Horizon Real Estate</Text>
      ...
      <TouchableOpacity className="bg-blue-600 py-4 rounded-xl items-center" onPress={handleRegister}>
